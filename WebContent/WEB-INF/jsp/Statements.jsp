		...
		<div class="row">
			...
			<div class="row">
				<div class="option col-sm-offset-4 col-sm-4">
					<a href="MiniStatement.mvc?id=${accId}"><div class="well statement">Show Mini Statement</div></a>
				</div>
			</div>
			<div class="row">
				<div class="option col-sm-offset-4 col-sm-4">
					<a href="DetailedStatement.mvc?id=${accId}"><div class="well statement">View Detailed Statement</div></a>
				</div>
			</div>
		</div>
	</div>
